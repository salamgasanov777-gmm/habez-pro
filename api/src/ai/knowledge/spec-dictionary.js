...
export const SPEC_KEYS = {
  ...
  // ── Производитель (Phase 3.4) ────────────────────────────────────────────
  // Только то, что источник прямо пишет («Изготовитель: …» на этикетке,
  // «Место производства: …»). В карточках таких строк пока нет, подписей
  // для переноса нет — ключи нужны для наблюдений с документом.
  manufacturer: { label: "Изготовитель", unit: null, group: "Производитель" },
  production_site: { label: "Место производства", unit: null, group: "Производитель" },
};
